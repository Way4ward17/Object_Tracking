...
public class Main {
	static {
		...
		//System.loadLibrary("opencv_java249");
    	 ...
    	 System.load("C:/opencv342/opencv/build/java/x86/opencv_java342.dll");
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//camera.open(CONFIG.filename);
                 String path = System.getProperty("user.home");  
                camera.open(path+"\\Documents\\NetBeansProjects\\Moving-Target-Tracking-with-OpenCV-master\\atrium.avi");
		...
		while (true) {
			...
			if (i == 1) {
				...
				Imgproc.putText(imag,
						"Number of tracked Item: " + tracker.tracks.size()
								+ "     Removed: " + tracker.track_removed,
